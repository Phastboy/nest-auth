...
import { LikeUncheckedUpdateManyWithoutEventOccurrenceNestedInput } from '../like/like-unchecked-update-many-without-event-occurrence-nested.input';

@InputType()
export class EventOccurrenceUncheckedUpdateWithoutCommentsInput {
  ...
  @Field(() => LikeUncheckedUpdateManyWithoutEventOccurrenceNestedInput, {
    nullable: true,
  })
  likes?: LikeUncheckedUpdateManyWithoutEventOccurrenceNestedInput;
}
