...
import { RoomUpdateManyWithoutBuildingNestedInput } from '../room/room-update-many-without-building-nested.input';

@InputType()
export class BuildingUpdateWithoutEventOccurrenceInput {
